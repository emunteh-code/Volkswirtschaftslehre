...
| `jahresabschluss` | 15 | 0 | 100% | 100% | 40 | 49 | 13 | 13 | 0 | 5 | 45 | 4 |
...
| `jahresabschluss` | complete | official-task-source pilot present (5); 13 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | not achieved |
...
- `jahresabschluss`: official exam bank incomplete (official-task-source pilot present (5); 13 document-registry placeholders still unresolved)
