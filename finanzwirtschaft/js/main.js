...
import { getFinanzwirtschaftContentManifestBridgePayload } from './data/contentManifest.js';
...
createPortalApp({
  ...
  portalBridge: () => {
    ...
    window.__finanzwirtschaftContentManifest = getFinanzwirtschaftContentManifestBridgePayload();
  }
});
