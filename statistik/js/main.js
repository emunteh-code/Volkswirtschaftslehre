...
import { getStatistikContentManifestBridgePayload } from './data/contentManifest.js';
...
createPortalApp({
  ...
  portalBridge: () => {
    ...
    window.__statistikContentManifest = getStatistikContentManifestBridgePayload();
  }
});
