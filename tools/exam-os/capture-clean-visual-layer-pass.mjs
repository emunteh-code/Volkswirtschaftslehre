/**
 * Capture clean visual layer pass screenshots.
 * Run: node tools/exam-os/capture-clean-visual-layer-pass.mjs
 */
...
const outDir = path.join(repoRoot, "docs/audits/screenshots/clean-visual-layer-pass");
...
try {
  ...
  console.log("clean-visual-layer-pass screenshots: OK");
} finally {
  await browser.close();
}
