...
// Renders the learning progress dashboard + backbone metrics
// ============================================================
...
<p style="color:var(--muted);font-size:12px;margin-top:8px;margin-bottom:0">Lokal gespeicherte Fehler aus Schnelltest, Probeklausuren und weiteren Lernflüssen (sofern protokolliert).</p>
</div>`;
