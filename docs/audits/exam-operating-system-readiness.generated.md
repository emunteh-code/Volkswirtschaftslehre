# Exam Operating System Readiness Gate — 2026-06-15
...
| `makro2` | 30 | 0 | 100% | 100% | 77 | 100 | 23 | 22 | 0 | 17 | 110 | 4 |
...
| `jahresabschluss` | 15 | 0 | 100% | 100% | 54 | 56 | 13 | 13 | 0 | 12 | 45 | 4 |
...
| `makro2` | complete | official-task-source pilot present (17); 22 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | near, but official task-source review pending |
...
| `jahresabschluss` | complete | official-task-source pilot present (12); 13 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | not achieved |
...
- `mikro1`: official exam bank incomplete (official-task-source pilot present (10); 18 document-registry placeholders still unresolved)
...
- `makro2`: official exam bank incomplete (official-task-source pilot present (17); 22 document-registry placeholders still unresolved)
...
- `statistik`: official exam bank incomplete (official-task-source pilot present (10); 104 document-registry placeholders still unresolved)
...
- `jahresabschluss`: official exam bank incomplete (official-task-source pilot present (12); 13 document-registry placeholders still unresolved)
