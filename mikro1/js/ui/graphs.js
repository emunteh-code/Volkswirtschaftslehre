...
function drawHausopt(progress = 1) {
  ...
  ge.drawIK(ctx, axMax, ustar, col.accent2, 'Indiff.kurve I*', sx, sy, progress);
...
function drawMonopol(progress = 1) {
  ...
  // MC curve — animated with further delay
  if (progress >= 0.4) {
...
function drawSlutsky(progress = 1) {
  ...
  // Budget lines helper
  function bLine(p1, color, label, dash) {
  ...
  bLine(p1_1, col.warn,         'Budget (neu)',     false);
