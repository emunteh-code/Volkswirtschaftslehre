...
<canvas id="graph_canvas" width="920" height="560" role="img" aria-label="Phillipskurve: kurzfristige PC, uₙ und Punkt (u,π); Legende oben rechts."></canvas>
<div id="graph_info" class="graph-info" aria-live="polite"></div>
</div>`,
...
<canvas id="graph_canvas" width="920" height="640" role="img" aria-label="IS-LM-PC: IS-Kurve und Zinsregel oben, Phillipskurve unten; Legende oben rechts."></canvas>
<div id="graph_info" class="graph-info" aria-live="polite"></div>
</div>`
  };
