...
| `statistik` | 14 | 0 | 100% | 100% | 44 | 134 | 104 | 104 | 0 | 1 | 44 | 4 |
...
| `statistik` | complete | official-task-source pilot present (1); 104 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | not achieved |
...
- `statistik`: official exam bank incomplete (official-task-source pilot present (1); 104 document-registry placeholders still unresolved)
