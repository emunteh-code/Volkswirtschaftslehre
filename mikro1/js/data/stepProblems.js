...
const BASE_STEP_PROBLEMS = {
 ...
 context: 'u = x₁·x₂, p₁ = 2, p₂ = 4, m = 40',
 steps: [
 { q: 'Schreibe die Lagrange-Funktion auf (nur die Struktur, z.B. "L = u + λ(...)"):',
 answer: ['x1x2 + λ', 'x1*x2 + lambda', 'lagrange'],
 hint: 'ℒ = Zielfunktion + λ · (Budgetrestriktion in der Form m - p₁x₁ - p₂x₂)',
 explain: 'ℒ = x₁x₂ + λ(40 − 2x₁ − 4x₂)',
 traps: [] },
 { q: 'BEO 1: ∂ℒ/∂x₁ = 0 → welche Bedingung folgt?',
 answer: ['x2 = 2λ', 'x₂=2λ', 'x2=2*lambda'],
 hint: 'Leite nach x₁ ab: ∂(x₁x₂)/∂x₁ = x₂, ∂(λ·(...))/∂x₁ = −2λ',
 explain: 'x₂ − 2λ = 0 → x₂ = 2λ',
 traps: [] },
 { q: 'Aus BEO1 und BEO2 folgt x₂ = ? (als Funktion von x₁)',
 answer: ['x2 = x1/2', 'x₂=x₁/2', 'x1/2', '0.5x1'],
 hint: 'BEO2: x₁ = 4λ. Teile BEO1 durch BEO2 oder setze λ gleich.',
 explain: 'BEO1: x₂=2λ, BEO2: x₁=4λ. Division: x₂/x₁ = 2/4 = 1/2 → x₂ = x₁/2',
 traps: [{pattern:'x2 = 2x1', msg:'Kehrwert! x₂/x₁ = p₁/p₂ = 2/4 = 1/2, also x₂ = x₁/2, nicht x₂ = 2x₁.'}] },
 { q: 'Einsetzen in Budget → x₁* = ?',
 answer: ['10', 'x1=10'],
 hint: '2x₁ + 4·(x₁/2) = 40 → vereinfachen',
 explain: '2x₁ + 2x₁ = 40 → 4x₁ = 40 → x₁* = 10. Dann x₂* = 5.',
 traps: [] }
 ]
 }
 ],
 ...
 hausopt: [
 {
  title: 'Haushaltsoptimum berechnen',
  context: 'u(x₁,x₂) = x₁x₂, p₁ = 4, p₂ = 2, m = 40',
  steps: [
  { q: 'Tangentialbedingung: GRS = MU₁/MU₂ = x₂/x₁. Setze gleich p₁/p₂ und löse nach x₂.',
    answer: ['x2=2x1', 'x₂=2x₁', '2x1'],
    hint: 'x₂/x₁ = p₁/p₂ = 4/2 = 2. Auflösen nach x₂.',
    explain: 'GRS=x₂/x₁=p₁/p₂=4/2=2 ⟹ x₂=2x₁.',
    traps: [{pattern:'x1=2x2', msg:'Falsche Auflösungsrichtung. x₂/x₁=2 ⟹ x₂=2x₁, nicht x₁=2x₂.'}] },
  { q: 'Setze x₂=2x₁ in die Budgetgleichung ein und berechne x₁*.',
    answer: ['5', 'x1=5'],
    hint: '4x₁ + 2·(2x₁) = 40. Vereinfachen.',
    explain: '4x₁+4x₁=40 ⟹ 8x₁=40 ⟹ x₁*=5.',
    traps: [] },
  { q: 'Wie hoch ist der Maximalnutzen u* = x₁*·x₂*?',
    answer: ['50', '5*10', 'u=50'],
    hint: 'x₂* = 2·x₁* = 10. u* = x₁*·x₂*.',
    explain: 'x₂*=10. u*=5·10=50.',
    traps: [] }
  ]
 }
 ],
