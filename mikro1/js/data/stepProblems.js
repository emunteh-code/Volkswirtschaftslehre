...
const BASE_STEP_PROBLEMS = {
 ...
 { q: '[1. Interpretation] Bestimmen Sie den relativen Preis p₁/p₂.',
   answer: ['10'],
   options: { problemId: 'm1_lagrange', stepId: 'price_check', context: { type: 'price' } },
   hint: 'Teilen Sie p₁ durch p₂.',
   explain: 'p₁/p₂ = 10/1 = 10.' },
 { q: '[2. Decision] Welcher Lösungstyp liegt hier vor? (Innere oder Randlösung?)',
   answer: ['randlösung', 'corner'],
   options: { problemId: 'm1_lagrange', stepId: 'type_choice', isDecision: true },
 ...
 { q: '[3. Execution] Berechnen Sie die optimale Menge x₁*.',
   answer: ['0'],
   options: { problemId: 'm1_lagrange', stepId: 'exec_x1', context: { type: 'quantity', dependsOn: 'type_choice' } },
 ...
 { q: '[4. Validation] Berechnen Sie den resultierenden Nutzen u* im Punkt (0, 10).',
   answer: ['20'],
   hint: 'u = (0+2)*10.',
 ...
 { q: '[2. Execution] Berechnen Sie den reinen Substitutionseffekt (x₁_slutsky - x₁_alt).',
   answer: ['7.5', '7,5'],
   options: { problemId: 'm1_slutsky', stepId: 'se_calc', context: { dependsOn: 'se_dir' } },
   hint: 'x₁_slutsky = 12,5. Altes x₁=5.',
   explain: '12,5 - 5 = 7,5.' },
 { q: '[3. Validation] Formulieren Sie die vollständige Logik-Kette.',
   answer: ['p1↓ → se↑ → x1↑'],
   options: { problemId: 'm1_slutsky', requiredChain: ['p1↓', 'se↑', 'x1↑'], context: { premise: 'p1↓' } },
   hint: 'Nutzen Sie Symbole.',
   explain: 'Preis sinkt ⟹ SE positiv ⟹ Nachfrage steigt.' }
 ]
 }
 ]
};
