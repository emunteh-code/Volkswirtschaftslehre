...
| `jahresabschluss` | 15 | 0 | 100% | 100% | 34 | 46 | 13 | 13 | 0 | 2 | 45 | 4 |
...
| `jahresabschluss` | complete | official-task-source pilot present (2); 13 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | not achieved |
...
- `jahresabschluss`: official exam bank incomplete (official-task-source pilot present (2); 13 document-registry placeholders still unresolved)
