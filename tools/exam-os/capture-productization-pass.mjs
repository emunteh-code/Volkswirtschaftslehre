/**
 * Capture productization pass screenshots for audit comparison.
 * Run: node tools/exam-os/capture-productization-pass.mjs
 */
...
const outDir = path.join(repoRoot, "docs/audits/screenshots/productization-pass");
...
const TARGETS = [
  ...
  { module: "mikro1", consent: "mikro_consent_v1", concept: "cobbd", tab: "aufgaben", file: "mikro1-cobb-douglas-aufgaben.png" }
];
...
try {
  ...
  console.log("productization-pass screenshots: OK");
} finally {
  await browser.close();
}
