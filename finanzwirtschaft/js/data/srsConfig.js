// ============================================================
// SRS CONFIGURATION — Finanzwirtschaft
// Spaced Repetition System keys and interval levels
// ============================================================

export const SRS_KEY        = 'finanzwirtschaft_srs_v1';
export const PROGRESS_KEY   = 'finanzwirtschaft_progress_v1';
export const LAST_KEY       = 'finanzwirtschaft_last_v1';
export const STREAK_KEY     = 'finanzwirtschaft_streak_v1';
