...
<p style="color:var(--muted);font-size:12px;margin-top:8px;margin-bottom:0">Deine gespeicherten Fehler aus Schnelltest, Probeklausuren und weiteren Lernflüssen.</p>
</div>`;
