...
| `makro2` | 30 | 0 | 100% | 100% | 67 | 90 | 23 | 22 | 0 | 7 | 110 | 4 |
...
| `makro2` | complete | official-task-source pilot present (7); 22 document-registry placeholders still unresolved | complete | mastery items present; exam-bank or anchor gate open | near, but official task-source review pending |
...
- `makro2`: official exam bank incomplete (official-task-source pilot present (7); 22 document-registry placeholders still unresolved)
