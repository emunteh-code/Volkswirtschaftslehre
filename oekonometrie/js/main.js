...
import { getOekonometrieContentManifestBridgePayload } from './data/contentManifest.js';
...
createPortalApp({
  ...
  portalBridge: () => {
    ...
    window.__oekonometrieContentManifest = getOekonometrieContentManifestBridgePayload();
  }
});
