...
import { getJahresabschlussContentManifestBridgePayload } from './data/contentManifest.js';
...
createPortalApp({
  ...
  portalBridge: () => {
    ...
    window.__jahresabschlussContentManifest = getJahresabschlussContentManifestBridgePayload();
  }
});
